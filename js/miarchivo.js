...
function determinarEquipo() {
  ...
  let importaGanar = prompt("¿Te importa solamente ganar a cualquier costo, hasta quizas sobornando a un árbitro? (Responde 's' para sí, 'n' para no)");
  let jugarBien = prompt("¿Te importa jugar bien mas que ganar o perder? (Responde 's' para sí, 'n' para no)");
